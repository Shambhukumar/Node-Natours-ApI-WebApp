...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2Fta3VtYXIiLCJhIjoiY2syMzRrMnRpMGplZDNtbXpqN2lqbjdkcyJ9.31_i-8wD9Vs7SkBjNJFVHg';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //Extand map bounds to include current location
...
var stripe = Stripe('pk_test_dCe0d8Zv0Yd9i5NBs8a040uY00MHiRPbD1');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Account Created Successfully Please check Your Email!!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
var signInforom = document.querySelector('.signInforom');
var userForm = document.querySelector('.form-user-data');
var logOutBtn = document.querySelector('.nav__el--logout');
var userPasswordForm = document.querySelector('.form-user-password');
var bookBtn = document.getElementById('book-tour');
var signUpForm = document.querySelector('.signUpforom'); //DELEGATION
...
if (signInforom) {
  signInforom.addEventListener('submit', function (e) {
    e.preventDefault();
